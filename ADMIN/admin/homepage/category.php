                ...
                <div class="span12">
                    ...
                    <div id="horizontal" class="widget widget-form">
                        ...
                        <div class="widget-content">
                            ...
                            <form class="form-horizontal" method="post" action="index.php?page=category_action">
                                <fieldset>
                                    <input type="hidden" name="action" value="insert">
                                      ...
                                      <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="category_name" class="input-large" placeholder="Enter Your name..." id="input01">
                                        </div>
                                    </div>
