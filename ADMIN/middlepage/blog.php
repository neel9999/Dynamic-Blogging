				...
				<form action="#" method="post">
						<div class="form-row">
								<div class="col-md-6 mb-3">
									...
									<select class="form-control" id="validationDefault01"></select>

								</div>
								<div class="col-md-6 mb-3">
										<label for="validationCustom02">Sub Category</label>
									<select class="form-control" id="validationDefault02"></select>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">
										<label for="exampleInputPassword1 mb-2">Blog Name</label>
									<input type="text" class="form-control">
								</div>
								<div class="form-group col-md-6">
										<label for="exampleInputPassword2 mb-2">Description</label>
										<input type="textarea" multiline="true" class="form-control">
									</div>
